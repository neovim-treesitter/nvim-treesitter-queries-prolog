# nvim-treesitter-queries-prolog

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-prolog/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-prolog/actions/workflows/validate.yml)

Neovim tree-sitter queries for **prolog**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-prolog",
...
- [ ] Changes are scoped to `prolog` — do not include files for other languages
